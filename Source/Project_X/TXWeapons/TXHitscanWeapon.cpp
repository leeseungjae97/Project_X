...
ATXHitscanWeapon::ATXHitscanWeapon()
{
	PrimaryActorTick.bCanEverTick = false;
	SetWeaponType(EWeaponType::EWT_Hitscan);
}

void ATXHitscanWeapon::Fire()
{
...
void ATXHitscanWeapon::SetVisibility(bool InbVisibility)
{
	Super::SetVisibility(InbVisibility);
}

void ATXHitscanWeapon::TraceHitTarget(FHitResult& HitResult)
{
