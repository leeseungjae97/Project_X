...
#include "TXAssetManager.generated.h"

/**
 * 
 */
UCLASS() class PROJECT_X_API UTXAssetManager : public UAssetManager
{
	GENERATED_BODY()
...
template <typename T>
T* UTXAssetManager::LoadAsset(const FString& RepPath)
{
	if (RepPath.IsEmpty())
	{
...
template <typename T>
void UTXAssetManager::LoadAssetAsync(const FString& RepPath, TFunction<void(T*)> OnLoaded)
{
