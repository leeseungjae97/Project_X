...
#include "Interfaces/TXLockOnTargetInterface.h"
#include "CombatEnemy.generated.h"

class UWidgetComponent;
class UTXMapPointComponent;
 ...
 */
UCLASS(abstract)
class ACombatEnemy : public ACharacter, public ICombatAttacker, public IDamageable, public ITXLockOnTargetInterface
{
	GENERATED_BODY()
	...
	UTXMapPointComponent* MapPointComponent;
...
public:
	// ~begin ITXLockOnTargetInterface
	virtual FVector GetLockOnSocketLocation_Implementation() const override;
	virtual void SetLockOnTargeted_Implementation(bool bIsTargeted) override;
	// ~end ITXLockOnTargetInterface
