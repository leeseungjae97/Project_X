...
void AProject_XCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		EnhancedInputComponent->BindAction(MouseLookAction, ETriggerEvent::Triggered, this, &AProject_XCharacter::Look);
...
void AProject_XCharacter::DoMove(float Right, float Forward)
{
...
void AProject_XCharacter::DoLook(float Yaw, float Pitch)
{
	if (GetController() != nullptr)
	{
...
void AProject_XCharacter::DoJumpStart()
{
	// signal the character to jump
	Jump();
}

void AProject_XCharacter::DoJumpEnd()
{
