 ...
 */
UCLASS(abstract)
class ACombatEnemy : public ACharacter, public ICombatAttacker, public IDamageable, public IPXLockOnTargetInterface
{
	GENERATED_BODY()
	...
	UPXMapPointComponent* MapPointComponent;
...
protected:
	...
	UPROPERTY(EditAnywhere, Category="Damage")
	UPXCombatLifeBar* LifeBarWidget;
